                ...
                <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <img src="{{ asset('storage/post/'.$post->image) }}" width="400" height="200" alt="No previous picture">
                                </div>
                            </div>
                            ...
                            <input type="checkbox" name="status" value="1" {{ $post->status == true ? 'checked' : ''}} id="md_checkbox_30" class="filled-in chk-col-green">
