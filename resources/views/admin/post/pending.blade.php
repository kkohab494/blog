...
<section class="content">
    <div class="container-fluid">
        <div class="header">
            <h1><a href="{{ route('admin.post.create') }}" class="btn btn-success m-t-15 waves-effect">
                                ...
                                <tbody>
                                    @foreach ($posts as $key=>$post)
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="{{ route('admin.post.edit', $post->id) }}" class="btn btn-success waves-effect"><i class="material-icons">edit</i></a>
                                            <button onclick="deleteFrom({{$post->id}})" class="btn btn-danger waves-effect"><i class="material-icons">delete</i></button>
                                            <form id="delete-form" action="{{ route('admin.post.destroy', $post->id) }}" method="POST" style="display: none;">
                                                @csrf
                                                @method('DELETE')
